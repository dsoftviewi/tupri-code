...
<html lang="en">
 ...
 <body class="tooltips">
          ...
          <div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT -->
            <?php include($_SESSION['grp']."/mysetting.php");?>
    ...
    $(document).ready(function() 
	{
        ...
        <script src="core/assets/plugins/ajax_upload/jquery.form.js"></script>
  ...
  <script>
   $(function() { $('#bulletin').bulletin(); });
		...
		$('#dvLoading').fadeOut(500);
		 ...
		 $(document).ready(function() { 
					$('#photoimg').live('change', function(result)			
					{
						$("#preview").html('');
      ...
      toastr.info('Logo add/change successful...');
							}
					}).submit();
...
<?php if((isset($_GET['tost'])) && ($_GET['tost']==1)){?>
    ...
    $(document).ready(function() {
      ...
      toastr.info('Profit % change successful...');
            });
