...
{
	$package = $conn->prepare("SELECT * FROM dvi_packages where status='0' and sno=? and pack_grp='IN' ORDER BY pack_prior ASC");
}else{
	$package = $conn->prepare("SELECT * FROM dvi_packages where status='0' and sno=? and pack_grp='IN' ORDER BY pack_prior ASC LIMIT 10");
}
                                ...
                                <tr>
                                    <td width="60%">
                                     ...
                                     <?php 
                                            if($i==0){
                                             ?>
                                     <td width="40%"><span class="price"></span>
<a  class="button btn-small  text-center " style="background-color: rgb(148, 183, 54);width:46%;float:left;"  href="internation_itin.php" >Back</a>
                                      <a class="button btn-small text-center"  href="view_package_pdf.php?pack_id=<?php echo $row_package['sno']; ?>" target="_blank" style="background-color: rgb(148, 183, 54);margin-left:3px"  href="internation_itin.php">&nbsp;&nbsp;<i class="fa fa-download"></i>&nbsp; Download &nbsp;</a></td>
                                     <?php } ?>
                                 </tr>
                             </table>
                                            </div>
...
<a  class="button btn-small  text-center " style="background-color: rgb(148, 183, 54);width:45%;float:left;"  href="internation_itin.php" data_target="_blank">Back</a>
