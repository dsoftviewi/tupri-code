...
<!--		<link href="core/assets/plugins/validator/bootstrapValidator.min.css" rel="stylesheet">-->
	...
	<!--	<link href="core/assets/plugins/slider/slider.min.css" rel="stylesheet">
		...
		#dvLoading
		{
			...
			height: 100%;
			z-index: 9999;
			background: url(images/arrow_loder.gif) center no-repeat #fff;
 ...
 <body class="tooltips">
          ...
          <div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT -->
            <?php include($_SESSION['grp']."/tourplan1.php");?>
...
{
	$.get('<?php echo $_SESSION['grp'].'/row_cities.php' ?>', { incr1 : mrow, incr2 : srow, city_id: arr_city_id, arr_vehids: vehids }, function(data,sts,xh) {
//		alert(data);
...
function create_elmt()
{
	veh_cnt++;
	document.getElementById('vehdiv').value=veh_cnt;
	var sel_claus = "<div class='form-group' id='delete"+veh_cnt+"'><div class='row'><label class='col-sm-2 control-label'>Select Extra Vehicle</label><div class='col-sm-6' id='divs1"+veh_cnt+"'></div><div class='col-sm-2'><a title='Remove row' class='btn btn-default' onclick=remove_elmt('delete"+veh_cnt+"')><i class='fa fa-trash-o' style='color:#3EAFDB'></i></a></div><small class='help-block' id='seaterr"+veh_cnt+"' style='display:none; color:#E9573F;'></small></div></div>";
