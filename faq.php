...
if($total_faq_view>0)
{
	...
	foreach($row_faq_view_main as $row_faq_view)
	{
                                    ...
                                    <div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg<?php echo $f; ?>"><?php echo $row_faq_view['faq_quest'];?> </a>
                                        </h4>
                                        <div id="tgg<?php echo $f; ?>" class="panel-collapse collapse <?php if($f==1){ ?> in <?php } ?>">
                                            <div class="panel-content">
                                              <?php echo $row_faq_view['faq_ans']; ?>  
...
<div class="panel style1">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" href="#tgg1" class="collapsed ">How to book my tour plan? </a>
                                        </h4>
