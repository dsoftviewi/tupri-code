...
$you = $conn->prepare("SELECT * FROM distributor_pro where distr_id =?");
$you->execute(array($_SESSION['uid']));
$row_you = $you->fetch(PDO::FETCH_ASSOC);
$totalRows_you = $you->rowCount();
$folder="distributor_img";
$row_you['agent_addr']=$row_you['distr_addr'];
$diss='1';
}
        ...
        <body class="div-nicescroller">
                    ...
                    <div class="the-box no-border">
                        <div class="row">
                            ...
                            <a class="btn btn-default" href="itin_trav_hot_pdf.php?mm=<?php echo $_GET['mm'];?>&sm=<?php echo $_GET['sm'];?>&planid=<?php echo urlencode($_GET['planid']); ?>"><i class="fa fa-download"></i> &nbsp;Download</a>
                    ...
                    <div class="row">
                    <?php if($diss==0){?>
                   <img src="../img_upload/<?php echo $folder; ?>/logo/<?php echo $row_you['comp_logo']; ?>" height="250px" width="250px" alt="Agent Logo" style="margin-left:30px; margin-top:20px;"/>
                   <?php }else{?>
                      ...
                      <hr style="margin-top: 10px;margin-bottom: 10px;" />
                        <div class="the-box" style="vertical-align: text-middle; border:thin #666 1px;">
							<div class="row">
                                ...
                                <?php if($diss==0){?>
									<img  src="../img_upload/<?php echo $folder; ?>/logo/<?php echo $row_you['comp_logo']; ?>"  height="75px" width="75px" alt="Your Logo"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <?php }else{?>
                                    <img  src="../images/dvi_pdf.png"  height="75px" width="75px" alt="DVI Logo"/>
                                    <?php }?><br>
...
$totalRows_hot1 = $hot1->rowCount();
								...
								if(isset($area_cnt[$row_trv['tr_to_cityid']])){
