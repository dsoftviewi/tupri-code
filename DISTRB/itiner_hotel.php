...
<html><head>
        ...
        <body class="div-nicescroller">
                    ...
                    <div class="row">
                   <img src="../img_upload/agent_img/logo/<?php echo $row_you['comp_logo']; ?>" width="250px" height="250px" alt="DVI Logo" style="margin-left:30px; margin-top:20px;"/>
...
?>
               ...
               <tr><td width="50%" class="tdstyle">&nbsp;Guest Name</td><td width="50%" class="tdstyle" >&nbsp;Mr/Mrs.&nbsp;<?php echo $row_orders['tr_name']." * ".$row_orders['pax_cnt']; ?></td></tr>
