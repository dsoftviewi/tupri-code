...
<div class="top-navbar info-color">
                ...
                <div class="modal fade" id="followup_modal" tabindex="-1" role="dialog" aria-hidden="true"  data-keyboard="false"  >
					...
					{
					?>
						<a href="dashboard_maintain.php"><img style="margin-left:-25px" src="img_upload/agent_img/logo/<?php if(trim($row_logo['comp_logo'])!=''){  echo $row_logo['comp_logo']; }else { echo "logo.png"; }?>" height="60" alt="logo"></a>
                        <?php
					}
					else
					{
					?>
                        <a href="dashboard_maintain.php"><img style="margin-left:-25px" src="core/assets/img/logo.png" height="60" alt="logo"></a>
                        <?php
					}
						?>
					</div><!-- /.logo-brand -->
...
if(isset($_SESSION['grp']) && $_SESSION['grp']=="ADMINS")
{
