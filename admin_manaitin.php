...
<html lang="en">
	<head>
		...
		<title>DVI Holidays | HotSpots Pro</title>
 ...
 <body class="tooltips">
          ...
          <div class="page-content">
            ...
            <?php include($_SESSION['grp']."/itin_pro.php");?>
  ...
  //  parent.location.reload();
	...
	afterClose : function() {/*
			...
			var spot_id=$('#sid11').val();
			
			var type=11;
			$.get("ADMIN/ajax_hotel.php?sid="+spot_id+"&type="+type,function(result)
			{
				//alert(result);
					 parent.location.reload();
			});
...
if(isset($_GET['tost']) && (isset($_GET['tost'])== md5(4))){
	?>
<script>
      toastr.options={   
          "closeButton":true,
      ...
      toastr.success("<?php echo $_GET['rec1']; ?> - details updated successfully..!");
     </script>
<?php  }
if(isset($_GET['tost']) && (isset($_GET['tost'])== md5(6))){
	?>
<script>
      toastr.options={   
          "closeButton":true,
      ...
      toastr.info("<?php echo $_GET['rec2']; ?> - added successfully..!");
     </script>
<?php  } 
...
<script>
      ...
      toastr.info("<?php echo $_GET['rec3']; ?> - records added successfully..!");
     </script>
<?php  } ?>	
