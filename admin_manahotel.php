...
<html lang="en">
	<head>
		...
		<title>DVI Holidays | Hotels Pro</title>
 ...
 <body class="tooltips">
          ...
          <div class="page-content">
			...
			<!-- BEGIN PAGE CONTENT -->
            <?php include($_SESSION['grp']."/hotel_pro.php");?>
  ...
  // added 50px to avoid scrollbars inside fancybox
   ...
   this.height = ($('.fancybox-iframe').contents().find('html').height())+40;
  },
...
$(function() {
	//alert('f');
$('.tagname').tagsInput({allowDuplicates: 'true'});
