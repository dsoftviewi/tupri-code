...
$totalRows_spro = $spro->rowCount();
  ...
  $html.='<tr><td colspan="6"><table width="100%" border="0">
      ...
      <tr >
        <td width="20%"><font style="font-weight:  font-family:; text-align: center; font-size: 14px">Guest Name</font></td>
        <td width="1%">:</td>
        <td width="79%"><font style="font-weight:  font-family:; text-align: center; font-size: 14px"> '.$customer_name.'</font></td>
      </tr>
      <tr>
        <td><font style="font-weight:  font-family:; text-align: center; font-size: 14px">Occupancy</font></td>
        <td>:</td>
        <td><font style="font-weight:  font-family:; text-align: center; font-size: 14px">'.$row_orders['pax_cnt'].'</font></td>
      </tr>
      <tr>
        <td><font style="font-weight:  font-family:; text-align: center; font-size: 14px">Total Traveling days</font></td>
        <td>:</td>
...
$totalRows_spro1 = $spro1->rowCount();
	...
	$html.='<tr style="text-align: left;  font-family:; font-size: 14px">
		...
		$html.='</td>
   	  ...
   	  $scnt++;
	} while($row_spro = $spro->fetch(PDO::FETCH_ASSOC));
	  $html.='</tr>
    </table>
...
$i=0;
while($totalRows_trv>0 && $totalRows_spro1>0){
...
$totalRows_hot1 = $hot1->rowCount();
					...
					{//between 3pm to 6pm ( over night in diff city)
						...
						if($totalRows_hot>0)
						{
							...
							{
								$hots_array[$vg]=$row_hot['spot_name'];
								$hots_with_idd[$vg]=$row_hot['hotspot_id'];
								$vg++;
							}
...
$totalRows_agent = $agent->rowCount();
      ...
      <tr>
        ...
        <td style="border:none"><p style="font-weight:  font-family:; font-size: 14px; text-align: right; margin-right:10px;">Authorised Signatory,</p></td>
      </tr>
      <tr>
...
//hotspots history start
 ...
 <tr ><td style="text-align:center"><strong style="color:#737373"><u>Place Description With sight-seeing Spots</u></strong></td></tr>
...
foreach($row_sphist_main as $row_sphist)
{
    ...
    <table style="width:98% ;border:1px solid #DEDEDE; font-family: ; text-align: left; font-size: 14px">
...
$totalRows_dvcity_hist =$dvcity_hist->rowCount();
	...
	{
     $html.='
           <tr style="background-color:; font-weight:600;"><td width="35%">Visiting Spots</td><td width="65%">Opening and Closing Time</td></tr>';
...
$totalRows_sy_ntx = $sy_ntx->rowCount();
      ...
      <tr>
        <td colspan="2" height="1px"><b>Package does not include</b></td>
      </tr>
      <tr>
