...
$file=$_FILES["agn_image"]["name"];
 if(trim($_FILES["agn_image"]["name"]) != '')
 {
	// echo "dd".$row_agent['agent_img'];
	 unlink('img_upload/agent_img/'.$row_agent['agent_img']);
	  $FileType = pathinfo($file,PATHINFO_EXTENSION);
  $profile=$_GET['aid'].'.'.$FileType;
$target_file='img_upload/agent_img/'.$profile;
move_uploaded_file($_FILES["agn_image"]["tmp_name"], $target_file);
 ...
 //$updates="UPDATE agent_pro set brokerage_perc='".$_POST['agt_def_perc']."',distr_id='".$_POST['distributor']."', agent_fname='".$_POST['agn_fname']."', agent_lname='".$_POST['agn_lname']."', agent_addr='".$_POST['addr']."', comp_name='".$_POST['agn_cname']."', busi_volume='".$_POST['agn_bvolume']."',state='".$_POST['agn_state']."',city='".$_POST['hotel_city']."', land_line='".$_POST['agn_landline']."', mobile_no='".$_POST['agn_mobile']."',email_id='".$_POST['agn_email']."',fax_no='".$_POST['agn_fax']."', iata_no='".$_POST['agn_iatano']."', bank_addr='".$_POST['agn_bk_addr']."' ,bank_acc_no='".$_POST['agn_bk_acc']."', bank_ifsc_code='".$_POST['agn_bk_ifsc']."',agent_img='".$profile."',work_state='".$_POST['agnt_work_state']."' where agent_id='".$_GET['aid']."'";
 $updates=$conn->prepare("UPDATE agent_pro set brokerage_perc=?,distr_id=?,agent_fname=?,agent_lname=?,agent_addr=?,comp_name=?,busi_volume=?,state=?,city=?,land_line=?,mobile_no=?,email_id=?,fax_no=?,iata_no=?,bank_addr=?,bank_acc_no=?,bank_ifsc_code=?,agent_img=?,work_state=? where agent_id=?");
 $updates->execute(array($_POST['agt_def_perc'],$_POST['distributor'],$_POST['agn_fname'],$_POST['agn_lname'],$_POST['addr'],$_POST['agn_cname'],$_POST['agn_bvolume'],$_POST['agn_state'],$_POST['hotel_city'],$_POST['agn_landline'],$_POST['agn_mobile'],$_POST['agn_email'],$_POST['agn_fax'],$_POST['agn_iatano'],$_POST['agn_bk_addr'],$_POST['agn_bk_acc'],$_POST['agn_bk_ifsc'],$profile,$_POST['agnt_work_state'],$_GET['aid']));			
...
echo "<script>parent.document.location.href='../admin_manaagent.php?mm=".$_GET['mm']."&sm=".$_GET['sm']."&rec2=".md5(4)."&name=".$cn."';</script>"; 
						...
						<div class="col-sm-12">
							<div class="panel panel-primary">
							  <div class="panel-heading">
								<h3 class="panel-title"><i class=" glyphicon glyphicon-user"></i> Update - <?php echo $row_agent['agent_fname']; ?>
                                <span class="right-content">
									<?php echo "[ IP :".$row_agent['ip_addr']." - when registered - ".date("d-M-Y",strtotime(substr($row_agent['datetime'],0,10)))." ]"?>
							...
							<div class="col-sm-12">
                                   ...
                                   <div id="first_div_id" >
                                   <center><strong style="color:#CCC"> Agent Personal Infomations</strong></center>
                                   <br />
                                                <div class="row">
									<div class="col-sm-6">
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Agent First Name" ><i class="fa fa-tag fa-fw"  ></i></span> 
										  <input type="text" name="agn_fname" id="agn_fname"  class="form-control" placeholder="First Name" value="<?php echo $row_agent['agent_fname'];?>">
										</div>
									      </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Agent Last Name" ><i class="fa fa-tag fa-fw"  ></i></span>
										  <input type="text" name="agn_lname" id="agn_lname" class="form-control" placeholder="Last Name" value="<?php echo $row_agent['agent_lname'];?>">
										</div>
									      </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Company Name" ><i class="fa fa-building-o fa-fw"  ></i></span>
										  <input type="text" name="agn_cname" id="agn_cname"  class="form-control" placeholder="Company Number" value="<?php echo $row_agent['comp_name'];?>">
										</div>
									   </div>
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Business Volume" ><i class="fa  fa-building fa-fw"  ></i></span>
										  <input type="text" name="agn_bvolume"  id="agn_bvolume" class="form-control" placeholder="Business Volume" value="<?php echo $row_agent['busi_volume'];?>">
										</div>
									   </div>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Land-Line Number"><i class="fa  fa-phone fa-fw"></i></span>
										 <input type="text" placeholder="Land-Line Number" class="form-control" name="agn_landline" id="agn_landline" value="<?php echo $row_agent['land_line'];?>">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Mobile Number" ><i class="fa  fa-mobile fa-fw"  ></i></span>
										  <input type="text" name="agn_mobile" id="agn_mobile"  class="form-control" placeholder="Mobile Number" value="<?php echo $row_agent['mobile_no'];?>">
										</div>
									   </div>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Email ID"><i class="fa fa-envelope  fa-fw"></i></span>
										 <input type="text" placeholder="Email ID" class="form-control" name="agn_email" id="agn_email" value="<?php echo $row_agent['email_id'];?>" readonly>
										</div>
                                        </div>
                                </div>
                                    <div class="col-sm-6">
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Fax Number"><i class="fa fa-fax fa-fw"></i></span>
										 <input type="text" placeholder="Fax Number" class="form-control" name="agn_fax" id="agn_fax" value="<?php echo $row_agent['fax_no'];?>">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="IATA Number"><i class="fa fa-plane fa-fw"></i></span>
										 <input type="text" placeholder="IATA Number" class="form-control" name="agn_iatano" id="agn_iatano" value="<?php echo $row_agent['iata_no'];?>">
										</div>
                                        </div>
                                </div>
                  				<div class="col-sm-6">
									...
									?>
										...
										<span class="input-group-addon tooltips" data-original-title="Distributor Name" ><i class="fa  fa-users fa-fw"  ></i></span>
										  <select data-placeholder="Choose Distributor" name="distributor" id="distributor" class="form-control chosen-select col-lg-12 " tabindex="2"  >									
                                         <option ></option>	
										 <?php foreach($row_distr_main as $row_distr) {
											 if($row_agent['distr_id']==$row_distr['distr_id'])
											 {
											 ?>
										<option selected value="<?php echo $row_distr['distr_id'];?>"><?php echo $row_distr['distr_fname']."&nbsp;".$row_distr['distr_lname'];?></option>   <?php }else {?>
                                ...
                                <div class="form-group">
										 <div class="input-group">
										<span class="input-group-addon tooltips" data-original-title="Admin Markup Percentage"><i class="fa fa-play fa-fw"></i></span>
										  <input type="text" class="form-control" data-placeholder="Admin Markup Percentage" value="<?php echo $row_agent['brokerage_perc']; ?>" name="agt_def_perc" id="agt_def_perc" />
                                ...
                                <div class="form-group">
                                        ...
                                        <label id="lbl_id1"  style="color:#CCC; ">Current Image :</label>
                                         ...
                                         <div class="col-sm-5">
                                         <img id="imm" class="pull-left" src="img_upload/agent_img/<?php echo $row_agent['agent_img']; ?>" style="width:70px; height:70px" >
                                ...
                                <div class="col-sm-6">
									...
									<span class="input-group-addon tooltips" data-original-title="Working State "><i class="fa fa-globe fa-fw"></i></span>
										 <select id="agnt_work_state" name="agnt_work_state" class="form-control chosen-select col-lg-12 " tabindex="2"   data-placeholder="Choose Work State" >									
                                         <option ></option>	
										 <?php foreach($row_hotelstate_main as $row_hotelstate) {
											 if($row_agent['work_state']==$row_hotelstate['code'])
											 {
											 ?>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Bank Information"><i class="fa fa-university fa-fw"></i></span>
										 <textarea placeholder="Bank Information or Address" class="form-control" name="agn_bk_addr" style="resize:none;"><?php echo $row_agent['bank_addr'];?></textarea>
										</div>
                                        </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Account Number"><i class="fa fa-tags fa-fw"></i></span>
										 <input type="text" placeholder="Account Number" class="form-control" name="agn_bk_acc" value="<?php echo $row_agent['bank_acc_no'];?>">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Bank - IFSC Code"><i class="fa fa-rocket fa-fw"></i></span>
										 <input type="text" placeholder="IFSC Code" class="form-control" name="agn_bk_ifsc"  value="<?php echo $row_agent['bank_ifsc_code'];?>">
										</div>
                                        </div>
                                </div>
                                </div>
									...
									<span class="input-group-addon tooltips" data-original-title="Agent State Location"><i class="fa fa-globe fa-fw"></i></span>
                                         ...
                                         <option ></option>	
										 <?php foreach($row_hotelstate_main as $row_hotelstate) {
											 if($row_agent['state']==$row_hotelstate['code'])
											 {
											 ?>
										<option selected value="<?php echo $row_hotelstate['code'];?>"><?php echo $row_hotelstate['name'];?></option> <?php }else{?>
                                        <option value="<?php echo $row_hotelstate['code'];?>"><?php echo $row_hotelstate['name'];?></option>
									...
									$hotelcity->execute(array($row_agent['state']));
									//$row_hotelstate= mysql_fetch_assoc($hotelstate);
									...
									?>
										 ...
										 foreach($row_hotelcity_main as $row_hotelcity) {
											   if($row_agent['city']==$row_hotelcity['id'])
											 {
											 ?>
                                ...
                                <div class="form-group">
										...
										<span class="input-group-addon tooltips" data-original-title="Residential Address"><i class="fa fa-home fa-fw"></i></span>
										  <textarea class="form-control no-resize" name="addr" id="addr"><?php echo $row_agent['agent_addr'];?></textarea>
										</div>
                                        </div>
                                </div>
                                </div>
...
function hide_first_div()
{
	...
	else if($('#distributor').val().trim()=='')
	{
		alert('Please Select Distributor');
		$('#distributor').focus();
	}else if($('#agt_def_perc').val().trim()=='')
	{
		alert('Please Enter Agent Markup Percentage');
		$('#agt_def_perc').focus();
	}else{
