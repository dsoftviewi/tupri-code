...
<?php } ?>
    ...
    <?php } //if end?>
               ...
               <!-- Additional cost - end -->
                            ...
                            <div class="the-box" style=" text-align:left; background-color:#E6ECF2;">
               <table width="100%">
               <tr><td style="padding:6px;"><strong  style="font-size: x-large;">Grand Total Of This Plan  </strong></td><td style="padding:6px;">:</td><td style="padding:6px;"><strong  style="font-size: x-large;"><?php echo  "<i class='fa fa-inr'></i> ".$row_orders['grand_tot']; ?></strong></td></tr>
			   ...
			   echo "<i class='fa fa-inr'></i> ".$adm_grand_amt = ($row_orders['grand_tot']+$prf); ?></strong></td></strong></tr>
               <tr><td style="padding:6px;"><strong  style="font-size: x-large;">Profit amount to DVI </strong></td><td style="padding:6px;">:</td><td style="padding:6px;"><strong  style="font-size: x-large;"><?php echo "<i class='fa fa-inr'></i> ".($prf) ?></strong></td></tr>
               <?php if($row_orders['agent_id']!='-' && $row_orders['agent_id']!='')
			   { 
			     $agentprf=($row_orders['grand_tot']*($row_orders['agent_perc']/100));
			   ?>
				   <tr><td style="padding:6px;"><strong  style="font-size: x-large;">Profit amount to agent(<?php echo $row_orders['agent_perc'].'%'; ?>)</strong></td><td style="padding:6px;">:</td><td style="padding:6px;"><strong  style="font-size: x-large;"><?php echo "<i class='fa fa-inr'></i> ".($agentprf) ?></strong></td></tr>
			   <?php }
			   ?>
                <tr><td style="padding:6px;"><strong  style="font-size: x-large;">This Itinerary Cost</strong></td><td style="padding:6px;">:</td><td style="padding:6px;"><strong  style="font-size: x-large;"><?php echo "<i class='fa fa-inr'></i> ".($row_orders['agnt_grand_tot']) ?></strong></td></tr>
               </table>
               </div>
                <?php  } //main for loop ?>        
