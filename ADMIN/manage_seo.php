...
$seo = $conn->prepare("SELECT * FROM seo_settings");
$seo->execute();
...
?>
					...
					<!-- Begin page heading -->
					<h1 class="page-heading">Manage SEO - Settings</h1>
					<!-- End page heading -->
					<!-- BEGIN DATA TABLE -->
					<div class="the-box">
...
<div class="row">
	<div class="col-sm-12" style="text-align:center; padding:10px; background-color: rgb(230, 248, 255);color: rgb(57, 123, 171);margin-bottom:20px">
		<div class="col-sm-10"><strong>Meta Tag - Keywords </strong></div>
...
<div class="row">
	<div class="col-sm-12" style="text-align:center; padding:10px; background-color: rgb(230, 248, 255);color: rgb(57, 123, 171);margin-bottom:20px">
		<div class="col-sm-10"><strong>Meta Tag - Description </strong></div>
		<div class="col-sm-2" align="center">
...
function fun_keywords(fld)
{
	...
	{
		$('#dvLoading').fadeIn();
		$.post('ADMIN/ajax_seo.php?type=1',{'field':fld, 'vals':kvals},function(result)
		{
			$('#dvLoading').fadeOut();	
			//alert(result);
