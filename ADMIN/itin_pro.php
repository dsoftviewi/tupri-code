...
?>
    ...
    <?php }?>								
                                  ...
                                  <li><a href="javascript:void(0);" onclick='removes("<?php  echo $row_hspotpro['hotspot_id'];?>","1")' ><i class="fa fa-trash-o"></i>&nbsp; Remove</a>
...
function pagi(val){
  ...
  var type="PAGINATION_ITN";
 var sm="<?php echo $_GET['sm'];?>";
 var mm="<?php echo $_GET['mm'];?>";
  var Datastring="type="+type+"&page="+val+"&sm="+sm+"&mm="+mm;
 // alert(Datastring);
  $.ajax({
