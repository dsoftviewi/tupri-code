...
$totalRows_hot = $hot->rowCount();
									...
									{
									 echo "After breakfast check out hotel ";
									}
									if($totalRows_hot>0){ 
									echo " and we have to visit following hotspot : ";
...
$totalRows_hotel2 = $hotel2->rowCount();
										...
										{
											echo " At the day end ,We will be having great dinner at ".$row_hotel2['hotel_name']."&nbsp;(&nbsp;".$row_trv['tr_to_cityid']."&nbsp;)&nbsp;.";
										}else if($row_sspro['sty_food']=='lunch_rate')
										{
											echo "In between we will be having great lunch at ".$row_hotel2['hotel_name']."&nbsp;(&nbsp;".$row_trv['tr_to_cityid']."&nbsp;)&nbsp;.";
										}else if($row_sspro['sty_food']=='both_food')
										{
											echo "In between we will be having great lunch and dinner at ".$row_hotel2['hotel_name']."&nbsp;(&nbsp;".$row_trv['tr_to_cityid']."&nbsp;)&nbsp;.";
											
										}?></span>
                                        <br />
                                        <span>Overnight stay at <?php echo $row_trv['tr_to_cityid']." in ".$row_hotel2['hotel_name']." ( ".$row_hotel2['category']." hotel )" ;?></span>
                                    </div>
...
$totalRows_hot = $hot->rowCount();
                                    ...
                                    <span style="color:#000;  font-size:14px; font-weight:600"> <?php echo $row_trv['tr_from_cityid']."&nbsp;&nbsp;-&nbsp;&nbsp;".$row_trv['tr_to_cityid']."&nbsp;( Departure )  [".$row_orders['tr_depdet']."&nbsp;]";?></span><br /><br />
                                        <span>After breakfast check out hotel and we transfer you to <?php echo $row_trv['tr_to_cityid']." airport/railway station.";?></span>
                                    </div>
