...
//print date("d-M-Y",strtotime($row_seashotel['from_date']));
	?>
                                 ...
                                 <div class="col-sm-3">
                                        <div class="form-group">
                                    <div class="input-group">
                               <label id="season1_id1" style="color:#C63">=&nbsp;&nbsp;&#x20b9;&nbsp;<?php echo $lunch_rate_arr[$sno]; ?></label>
					<input type="text" name="season1a" id="edit_season1a" class="form-control"  placeholder="Season 1 Rate" value="<?php echo $lunch_rate_arr[$sno]; ?>" style="display:none;">
										</div>
                                        <!--<small class="help-block" id="vnumerr" style=" display:none; color:#E9573F;" ></small>-->
                                        </div>
									</div>
...
if(in_array($sno,$child_without_bed_arr_keys)){
	...
	<br><small style="font-size: 11px;color: #F70909;"><?php echo date("d-M-Y",strtotime($row_seashotel['from_date'])).' - '.date("d-M-Y",strtotime($row_seashotel['to_date'])); ?></small></label>
                                 ...
                                 <div class="col-sm-3">
                                        <div class="form-group">
                                    <div class="input-group">
                               <label id="season1_id1" style="color:#C63">=&nbsp;&nbsp;&#x20b9;&nbsp;<?php echo $child_without_bed_arr[$sno]; ?></label>
					<input type="text" name="season1a" id="edit_season1a" class="form-control"  placeholder="Season 1 Rate" value="<?php echo $child_without_bed_arr[$sno]; ?>" style="display:none;">
										</div>
                                        <!--<small class="help-block" id="vnumerr" style=" display:none; color:#E9573F;" ></small>-->
                                        </div>
									</div>
