...
if(isset($_POST["addcity"])) 
{
	...
	$row_getcode = $getcode->fetch(PDO::FETCH_ASSOC);
 	...
 	$insertSQL1 = $conn->prepare("INSERT INTO dvi_cities (country, region, name, latitude, longitude) VALUES ('IN', ?, ?, ?, ?)");
	$insertSQL1->execute(array($row_getcode['code'],$_POST['cityname'],$_POST['latit'],$_POST['longit']));
