...
if($break_chk==0)
 {  
  ...
  <tr>
    <td colspan="6" style="text-align: center; font-family:; font-weight: bold; font-size: 62px;">'.$customer_name.'</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
$totalRows_trv--;
 ...
 $html.='<hr><table border="0" width="100%" style="font-family: ; text-align: left; font-size: 14px">
...
foreach($row_sphist_main as $row_sphist)
{
    ...
    $html.='<table style="width:100% ;border:1px solid #DEDEDE; font-family: ; text-align: left; font-size: 14px; margin-top:20px; ">
     ...
     $html.='<tr style="background-color:; font-weight:600;"><td width="35%">Visiting Spots</td><td width="65%">Opening and Closing Time</td></tr>';
		...
		for($hr=0;$hr<count($tot_spot_arr);$hr++)
		{
			if($tot_spot_arr[$hr]!='-' && $tot_spot_arr[$hr]!='')
			{
                ...
                $html.='<tr><td width="35%">'.$row_hstime['spot_name'].'</td><td width="65%">'.$row_hstime['spot_timings'].'</td></tr>';
			}
		}
           $html.='';
   }
...
$dompdf->render();
$dompdf->stream($plnid, array("Attachment" => false));
