...
{
	$html.='<img src="../images/dvi_pdf1.png" alt="DVI Logo" width="300px"; height="300px"; style="margin-top:20px; "/>';
}else{
	$html.='<img  src="../img_upload/agent_img/logo/'.$row_you['comp_logo'].'"  alt="DVI Logo" width="300px"; height="300px"; style="margin-top:20px; ">';
}
	$html.='</center></td>
  </tr>
  <tr>
...
$html.= $row_hotell['hotel_name']."&nbsp;";
      ...
      <tr>
		...
		<tr>
        <td colspan="2" style="text-align: center; font-weight: bold;border:none">'.$company_myname.' wishes you a pleasant stay</td>
        </tr>
      <tr>
      ...
      <tr>
		...
		$html.='<b>General Policies</b><br>
                                ...
                                <b>'.$company_myname.' will not be responsible for any check-in denied by the hotel due to the aforesaid reasons. Due to any natural or political or local issues if there is any damage to personal or tour '.$company_myname.' may not take the responsibility.</b><br>
