...
color: whitesmoke; padding: 5px;"><?php echo "Guest Name : ".$customer_name; ?></th></tr>
		<tr>
			...
			<th style="padding:6px; font-family:Calibri; font-size: 14px;">Room Information</th>
		...
		<tr>
			...
			<?php echo convert_currency_text("Rs",$_GET['planid'])." ".number_format(convert_currency($whole_pakcost,$_GET['planid']),2)." /-"; ?></th>
		</tr>
	</table>
...
$orders = $conn->prepare("SELECT * FROM travel_master where plan_id =?");
 ...
 <!-- <tr><td>
 			<table>
                 <tr><td style="font-family:Calibri; font-family:Calibri; font-size: 14px; font-weight:600">&nbsp;Guest Name</td><td>:</td><td style="font-family:Calibri; font-size: 14px; font-weight:600"><?php echo $customer_name; ?></td></tr>
...
}else
{
 ...
 <tr><td>
    ...
    <table border="1" width="" style="border-collapse: collapse;" >
    	<tr ><th colspan="7" style="text-align:center; padding:10px; font-family:Calibri; font-size: 14px;"> 
        		<strong style="color:#CE7708;">Travel & Stay Information </strong></th></tr>
        ...
        <th  style="padding:6px; font-family:Calibri; font-size: 14px;">&nbsp; Distance &nbsp;</th><!--<th>&nbsp; Travalling Time &nbsp;</th>-->
        <th  style="padding:6px; font-family:Calibri; font-size: 14px;">&nbsp; Staying Hotel</th>
        <th  style="padding:6px; font-family:Calibri; font-size: 14px;">&nbsp; Staying Room &nbsp; </th>
        <th  style="padding:6px; font-family:Calibri; font-size: 14px;">&nbsp; Meal Plan &nbsp;</th>
        </tr>
        <?php $ts=1; foreach($row_trvscd_main as $row_trvscd){?>
            ...
            <!--<td style="font-family:Calibri; font-size: 14px; font-weight:600; padding:5px">&nbsp;<?php echo $row_trvscd['tr_time']; ?>&nbsp;</td>-->
            <?php
				
				$stay = $conn->prepare("SELECT * FROM  stay_sched where stay_id =? and sty_date=?");
				$stay->execute(array($_GET['planid'],$row_trvscd['tr_date']));
				$row_stay = $stay->fetch(PDO::FETCH_ASSOC);
				$totalRows_stay = $stay->rowCount();
			?>
			...
			if($totalRows_stay>0)
			{
					...
					$hotell->execute(array($row_stay['hotel_id']));
			...
			if($totalRows_stay>0)
			{
									$rrom=explode(',',$row_stay['sty_room_name']);
...
}else
{
	echo $rrom1[$tt]." - ".$rrom2[$rrom1[$tt]]; 
			...
			{
									 //food items
									 if($row_stay['sty_food']=='dinner_rate')
									 {
										echo "Dinner"; 
									 }else if($row_stay['sty_food']=='lunch_rate')
									 {
										 echo "Lunch"; 
									 }else if($row_stay['sty_food']=='both_food')
									 {
										 echo "Lunch & Dinner"; 
									 }else{
										echo "Breakfast"; 
...
?>
			<table width="98%">
 			<?php  if($totalRows_trv>0){ ?>  
                    <tr><th colspan="3" style="text-align:center">Tour Itinerary Plan (Program schedule)</th></tr>
...
$totalRows_ss_dist = $ss_dist->rowCount();	
									...
									echo "";
									}?></font><br /><br /><font><?php //echo $totalRows_hot; 
		...
		echo  $row_dayhpot['spot_name'];
								 ...
								 echo "and later proceed to ".$row_trv['tr_to_cityid'].". Overnight stay at ".$row_hotel2['hotel_name']." hotel. ";
									 ...
									 $chn++;
                                        ...
                                        <tr><td width="17%"  class="f_weight" style="font-size:14px;">
                                    <?php
									if($row_trv['tr_date'] != '')
									{
										echo date('d-M-Y',strtotime(str_replace('-','/',$row_trv['tr_date'])));
                                 ...
                                 <td class="f_weight" style="font-size:14px;">
                                          <?php
...
$totalRows_hot = $hot->rowCount();
                                    ...
                                    <font style="color:#B16505;  font-size:14px; font-weight:600"> <?php echo $row_trv['tr_from_cityid']."&nbsp;&nbsp;";
