...
<table width="100%" border="0">
  ...
  if($str =='H' || ($str =='TH' && $totalRows_spro>0) )
  {
    ...
    <td colspan="6"><table width="100%" border="1">
      <tr style="font-weight: bold; text-align: left; font-family:sans-serif; font-size: 12px">
        ...
        <td style="padding:5px" width="25%">Room Category</td>
        <td style="padding:5px" width="15%">Meal Plan</td>
      </tr>';
...
$totalRows_hotell = $hotell->rowCount();
		...
		for($tt=0;$tt<count($rrom1);$tt++)
		{
			...
			{
				$html.=$rrom1[$tt]." - ".$rrom2[$rrom1[$tt]].",<br>"; 
			}else
			{
	  ...
	  $html.='<p style="font-size:12px;font-weight: bold; color:#900;" align="right">* Breakfast - complementary</p></td></tr>
    </table>
	</td>
  </tr>';
  }
...
if($row_count==0)
{
 $cy='yes'; //before hotel booking this itinerary was cancelled	
}
  if($str =='TH' && $row_count>0)
  {
  $html.='<tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
if($totalRows_trv>0){	
$html.='<tr><td colspan="3"><hr><font style="font-weight: bold; color:#900; font-family:sans-serif; text-align: center; font-size: 16px">Itinerary Details:</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
$totalRows_via_hspots =$via_hspots->rowCount();	
												...
												if($totalRows_via_hspots>0)
												{
													...
													{
														$html.=$row_via_hspots['spot_name'].'</strong> {'.$row_via_hspots['spot_timings'].' }, ';
													}
												}
											}
										}
...
$totalRows_hot = $hot->rowCount();
		$html.='</p></td>
<td><font style="font-weight: bold; font-family:sans-serif; text-align: center; font-size: 12px">';
$html.= $row_trv['tr_from_cityid']."&nbsp;&nbsp;-&nbsp;&nbsp;".$row_trv['tr_to_cityid'];
...
$html.="&nbsp;( Departure )  [ ".$row_orders['tr_depdet']."&nbsp; @".$row_orders['trv_depatr_time']." ]";
...
if($totalRows_trv>0){	
$html.='<tr>
    <td colspan="3"><font style="font-weight: bold; color:#900; font-family:sans-serif; text-align: center; font-size: 16px">Itinerary Details:';
	if($cy=='yes')
	{
	 $html.='<strong style="font-size:12px; color:#930">( But Staying details are not created ) </strong>';	
	}
	$html.='</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
