 ...
 <div class="modal-header bg-info no-border">
   <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
    ...
    <label class="pull-right" style="margin-top:-21px;"> Contact No : <?php echo $row_tmaster['tr_mobile']; ?></label>
     ...
     <div class="row">
    		<div class="col-sm-12" style=" height:40px;border-bottom:1px #CCCCCC solid; background-color:#F2EDE4">
            <div class="col-sm-3" style="color:#C63; font-weight:600;"></div>
            <div class="col-sm-3" style="color:#C63; font-weight:600;">Date  (<?php echo "&nbsp;Day - &nbsp;".$day_cnt; ?> ):</div>
             ...
             <div class="col-sm-3" style="color:#339; font-weight:600;"></div>
            </div>
            <div class="col-sm-12" style="margin-top:10px; margin-bottom:10px;">
			  ...
			  <?php echo $row_trvl['tr_from_cityid']."&nbsp;<i class='fa fa-long-arrow-right'></i>&nbsp;";
...
?>
              <?php
					 ...
					 $tsched = $conn->prepare("SELECT * FROM `travel_sched` WHERE `tr_date`=? and `travel_id` IN (select plan_id from travel_master where status=0 and agent_id=?)");
