...
}else
{
	...
	//	echo "day of stay par : ".$par;
		...
		/*	$shchild512=$_POST['youth_sel'.$h1];
			...
			if($_POST[$frm.'_food_id'.$h1]=='lunch_rate')
			{
				$perday_amtcal=$perday_amtcal+$food_person*$_POST[$frm.'_foood_rate'.$h1];
			}else if($_POST[$frm.'_food_id'.$h1]=='dinner_rate')
			{
				$perday_amtcal=$perday_amtcal+$food_person*$_POST[$frm.'_foood_rate'.$h1];
			}else if($_POST[$frm.'_food_id'.$h1]=='both_food')
			{
...
?>
                            <div class="row">
                                ...
                                <br>
                                    ...
                                    Monument OR TEMPLE Entrance Fees Boat ride<br>
                                    Insurance. <br>
