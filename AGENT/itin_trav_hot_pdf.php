...
<span>
<img  src="../img_upload/agent_img/logo/'.$row_you['comp_logo'].'"  height="65px" width="65px" alt="Your Logo"  style="margin-left:630px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<br>
<strong>Address : </strong><strong style="color:#F00">'.$row_you['comp_name'].'</strong>&nbsp;-&nbsp;<strong >'.$row_you['agent_addr'].'</strong><br />
<strong>Help Line : </strong><strong>24 * 7@ All India Customer Care - 9843288844</strong><br />
</div>';
...
$totalRows_orders = $orders->rowCount();
 ...
 $html.='<tr>
  ...
  <tr>
   ...
   <tr>
    <td colspan="6"><center> <img src="../img_upload/agent_img/logo/'.$row_you['comp_logo'].'" alt="Your Logo" width="300px"; height="300px"; style="margin-top:20px;"/></center></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
$totalRows_spro = $spro->rowCount();
  ...
  $html.='<tr><td colspan="6"><table width="100%" border="0">
      ...
      <tr >
        ...
        <td width="1%">:</td>
        <td width="79%"><font style="font-weight: bold; font-family:; text-align: center;font-size: 14px"> '.$customer_name.'</font></td>
      </tr>
      <tr>
  ...
  <tr>
    <td colspan="6"><table width="100%" border="1">
      <tr style="font-weight: bold; text-align: left; font-family:; font-size: 14px;  background-color:#EFEFEF">
        ...
        <td style="padding:5px" width="18%">Place</td>
        <td style="padding:5px" width="25%">Hotel</td>
        <td style="padding:5px" width="22%">Room Category</td>
        <td style="padding:5px" width="17%">Meal Plan</td>
      </tr>';
...
$html.='</td>
      ...
      <tr>
        <td style="background-color:#F5F5F5"><p style="text-align:justify; font-family:; font-size: 14px; color:#2D2A2A; line-height:20px;">';
...
if($totalRows_trv_new>0)
{
	...
	if($row_trv['tr_from_cityid']==$row_trv['tr_to_cityid'])
	{
		...
		{//between 6am to 3pm ( over night in same city)
			$html.= "Greet and meet on arrival at ".$row_trv['tr_from_cityid'].", proceed to hotel. Check in ( 12:00 noon - standard time) at hotel, refresh and later proceed to seeing sightseeing including - ";
			$hots_array=array();
			$hots_with_id=array();
			$vg=0;
...
$totalRows_via_hspots =$via_hspots->rowCount();		
												...
												if($totalRows_via_hspots>0)
												{
													...
													{
														$html.=$row_via_hspots['spot_name'].'</strong>, ';
															if($spot_ids!='-')
															{
		...
		else
		{
			...
			if($time6am <= $arr_date_tstmp && $arr_date_tstmp <= $time3pm)
			{
				...
				$html.= 'Greet and meet on arrival at '.$row_trv['tr_from_cityid'].', proceed to seeing sightseeing including - ';
				$hots_array=array();
				$hots_with_id=array();
				$vg=0;
				foreach($row_hot_main as $row_hot)
...
$totalRows_via_hspots =$via_hspots->rowCount();		
				...
				if($time11am >= $arr_date_tstmp)//within 11:00AM arrival means
				{
					...
					{//between 3pm to 6pm ( over night in diff city)
						...
						if($totalRows_hot>0)
						{
							$html.= 'If time permits proceed to seeing sightseeing including - ';
							$hots_array=array();
							$hots_with_id=array();
...
$totalRows_via_hspots =$via_hspots->rowCount();		
				...
				//additional cost - addons
                                    ...
                                    $html.='<div class="col-sm-12" style="color: #7A7FA2; margin-top:10px; border: 1px dashed #5F83DE; padding:3px;" >
...
{
    $html.=" - <strong>".$row_dayhpot['spot_name']."</strong>";
}
...
foreach($row_sspro1_main as $row_sspro1)
{
  ...
  $html.='<hr><table  class="tag"  style="border-top:#FFF; border-bottom:#FFF; border-left:#FFF; border-right:#FFF; margin-top:30px;" ><tr>
...
$html.= $row_hotell['hotel_name']."&nbsp;[&nbsp;".$row_hotell['category']."&nbsp;Hotel&nbsp;]";
      ...
      <tr>
       ...
       <tr>
        ...
        <td height="25px">'.$row_orders['pax_adults']."-Adults ";
		if($row_orders['pax_512child']!='0' && trim($row_orders['pax_512child'])!='' )
		{
...
if(trim($row_agent['comp_name'])=='' || trim($row_agent['comp_name'])=='-')
{
	$row_agent['comp_name']='DVI Holidays';	
}
      ...
      <tr>
		...
		<tr>
        <td colspan="2" style="text-align: center; font-weight: bold;border:none">'.$row_agent['comp_name'].' wishes you a pleasant stay</td>
        </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" style="text-align: left; font-family:;">';
		$html.='<b>General Policies</b><br>
                                ...
                                <b>'.$row_agent['comp_name'].' will not be responsible for any check-in denied by the hotel due to the aforesaid reasons. Due to any natural or political or local issues if there is any damage to personal or tour '.$row_agent['comp_name'].' ma not take the responsibility.</b><br>
 ...
 $html.='<hr><table border="0" width="100%" style=" text-align: left; font-size: 14px">
 <tr ><td style="text-align:center"><strong style="color:#737373"><u>Place Description With Shighseeing Spots</u></strong></td></tr>
...
foreach($row_sphist_main as $row_sphist)
{
    ...
    $html.='<table style="width:100% ;border:1px solid #DEDEDE;  text-align: left; font-size: 14px; margin-top:20px; ">
...
$totalRows_dvcity_hist =$dvcity_hist->rowCount();
		...
		if(trim($row_dvcity_hist['cdesc'])!='' && trim($row_dvcity_hist['cdesc'])!='-')
		{
		   $html.='<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>'.$row_dvcity2["name"].'&nbsp;&nbsp;:&nbsp;&nbsp;</strong>'.$row_dvcity_hist['cdesc'];
			...
			$html.='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Default Contant : This day, we are going to see local sightseeing spots.';	
		}
        $html.='</td>
    </tr>';
	...
	{
     $html.='<tr style="background-color:; font-weight:600;"><td width="35%" style="padding:6px">Visiting Spots</td><td width="65%">Opening and Closing Time</td></tr>';
		...
		for($hr=0;$hr<count($tot_spot_arr);$hr++)
		{
			if($tot_spot_arr[$hr]!='-' && $tot_spot_arr[$hr]!='')
			{
                ...
                $html.='<tr><td width="35%" style="padding:6px">'.$row_hstime['spot_name'].'</td><td width="65%">'.$row_hstime['spot_timings'].'</td></tr>';
			}
		}
           $html.='';
   }
...
$totalRows_sy_scd = $sy_scd->rowCount();
  ...
  <tr class="hide_border"> 
	...
	<table width="100%"  border="0" style="font-family:; margin-top:20px; text-align: left;font-size: 14px">
      <tr>
        <td class="hide_border" colspan="2"  height="55px;" style="text-align: left; font-weight: bold;"><br>Greetings from '.$row_agent['comp_name'].' !!!</td>
        </tr>
      <tr >
        <td class="hide_border" height="15px;" colspan="2">Thank you for your choice to use '.$row_agent['comp_name'].'</td>
        </tr>
      <tr>
        <td colspan="2" class="hide_border" ><p style="line-height:20px; ">The Motto of our company is to provide satisfactory servies to our entire guest. In order to achevieve this aim, we need to know your opinion on it. prasie would be a motivation for us to continue our services. And any critic would naturally be a reason for us to improve our services according to the requirements and desires of our Guests.</p></td>
        </tr>
      <tr>
      ...
      <tr>
        <td  colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Driver Name :<br><br><br></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
$totalRows_sy_ntx = $sy_ntx->rowCount();
	  ...
	  $i++;
		...
		<tr><td colspan="2 " class="hide_border">Please tell us about the overall feedback on '.$row_agent['comp_name'].' for organizing your tour.</td></tr>
		<tr><td colspan="2" class="hide_border">&nbsp;</td></tr>
		<tr><td width="20%" class="hide_border">Name</td><td class="hide_border" width="10%">:</td><td class="hide_border" witdth=70%></td></tr>
		<tr><td width="20%" class="hide_border">Email ID</td><td class="hide_border" width="10%">:</td><td class="hide_border" witdth=70%></td></tr>
		<tr><td width="20%" class="hide_border">Address</td><td class="hide_border" width="10%">:</td><td class="hide_border" witdth=70%></td></tr>
		<tr><td colspan="2" class="hide_border">&nbsp;</td></tr>
		<tr><td colspan="2" class="hide_border">&nbsp;</td></tr>
	  ...
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">IMPORTANT: Kindly note that names of hotels mentioned above only indicate that our rates have been based on usage of these hotels and it is not to be construed that accommodation is confirmed at these hotels until and unless we convey such confirmation to you. In the event of any of the above mentioned hotels not becoming available we shall book alternate accommodation at a similar or next best available hotel and shall pass on the difference of rates (supplement/reduction whatever applicable)<br><br></td>
      </tr>
	  <tr>
      ...
      <tr>
        <td colspan="2" height="1px" style="text-align: justify">Child cost depends upon hotels rule which may vary from one hotel to another. The most common rules are as under..</td>
      </tr>
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">Child up to 5 years is free. Child above 5 years to 12 will be charged as per hotel rule. Child above 12 years will be charged as adult.</td>
      </tr>
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">If your reservation at hotels includes an extra bed, most hotels provide a folding cot or a mattress on floor as an extra bed.</td>
      </tr>
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">Check in and check out in most of the hotels at 1200 noon in the cities, In Hill stastions check in 1400 hrs check out 11 hrs, </td>
      </tr>
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">Early check-in or late check-out is subject to availability and may be chargeable by the hotel.</td>
      </tr>
	  <tr>
        <td colspan="2" height="1px" style="text-align: justify">To request for an early check-in or late check-out, kindly contact the hotel directly or inform us prior.</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
//echo $html;
$file_nm=$row_orders['plan_id'].'_'.$row_orders['tr_name'].'.pdf';
$dompdf = new DOMPDF();
$dompdf->load_html($html);
  //$paper_size = array(0,0,612.00,792.00);
$dompdf->set_paper('A4','portrait');
$dompdf->render();
$dompdf->stream($file_nm, array("Attachment" => false));
