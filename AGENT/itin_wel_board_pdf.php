...
if(trim($row_you['comp_logo'])=='' || trim($row_you['comp_logo'])=='-')
{
	...
	$html.='</td>
		<td></td></tr>
	<tr><td style="font-weight: bold; font-family:; text-align: left; font-size: 62px"> Welcome</td></tr>
	<tr><td colspan="2" style="font-weight: bold; font-family:; text-align: center; font-size: '.$fsize.'">'.strtoupper($row_orders['tr_name']).'</td></tr> 
	</table>
</body>
<html>';

$fnfile=$row_orders['plan_id'].'_'.$row_orders['tr_name']."'s_Welcome_Board.pdf";
$dompdf = new DOMPDF();
