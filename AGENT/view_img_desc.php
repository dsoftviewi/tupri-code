...
<div class="col-sm-6">
											...
											foreach($images as $img){ ?>
                                              ...
                                              <br>
                                              <img src="../img_upload/hot_spots/<?php echo $img; ?>" alt="Image" style="width:433px; height:305px"></div>
                                              <?php } ?>
                                           ...
                                           <?php foreach($images as $img1){ ?>
											  <div class="item" style="height:15%; width:70%"><img src="../img_upload/hot_spots/<?php echo $img1; ?>"  alt="Image"  style="height:49px; width:77px" ></div>
                                              <?php } ?>
